...
variable "resources" {
  description = "A map of GCP resources that are inside of the service perimeter. Currently only projects are allowed. Keys are descriptive names for stable Terraform state."
  type        = map(string)
}
